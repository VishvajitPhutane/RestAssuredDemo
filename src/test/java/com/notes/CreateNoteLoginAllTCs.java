...
public class CreateNoteLoginAllTCs extends Notes_LoginTestData {
	...
	public void createNotes_TCS(String email, String password, String des, String exp_mes) {
		...
		Assert.assertEquals(act_msg, exp_mes );
